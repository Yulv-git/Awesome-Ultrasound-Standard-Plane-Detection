...
LastEditTime: 2022-04-05 17:02:48
...
def base_model(input_channels=3, img_size=(256, 256), cls_num=6, pretrained=False):
    model = Sequential()
...
if __name__ == "__main__":
    eval("base_model")(input_channels=3, img_size=(256, 256), cls_num=6)
