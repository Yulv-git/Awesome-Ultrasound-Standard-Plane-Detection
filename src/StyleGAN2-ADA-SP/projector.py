...
LastEditTime: 2022-03-31 22:45:16
FilePath: /Awesome-Ultrasound-Standard-Plane-Detection/src/StyleGAN2-ADA/projector.py
...
if __name__ == "__main__":
    ...
    '''
    parser = argparse.ArgumentParser(description='Project given image to the latent space of pretrained network pickle.',
