...
LastEditTime: 2022-03-31 22:32:36
FilePath: /Awesome-Ultrasound-Standard-Plane-Detection/src/StyleGAN2-ADA/train.py
Description: Train a GAN using the techniques described in the
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train a GAN using the StyleGAN2-ADA.',
                                    epilog=_cmdline_help_epilog, formatter_class=argparse.RawDescriptionHelpFormatter)
