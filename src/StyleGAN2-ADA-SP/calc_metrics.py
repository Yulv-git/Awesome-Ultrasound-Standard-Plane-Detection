...
LastEditTime: 2022-03-31 23:07:59
FilePath: /Awesome-Ultrasound-Standard-Plane-Detection/src/StyleGAN2-ADA/calc_metrics.py
...
if __name__ == "__main__":
    ...
    '''
    parser = argparse.ArgumentParser(description='Calculate quality metrics for previous training run or pretrained network pickle.',
