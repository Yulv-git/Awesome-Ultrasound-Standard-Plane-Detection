 ...
 * @Date: 2022-03-31 16:40:17
 * @Motto: Entities should not be multiplied unnecessarily.
 * @LastEditors: Shuangchi He
 * @LastEditTime: 2022-03-31 21:41:45
 * @FilePath: /Awesome-Ultrasound-Standard-Plane-Detection/src/StyleGAN2-ADA/README.md
 * @Description: StyleGAN2 with adaptive discriminator augmentation (ADA). 
 * Init from https://github.com/albertoMontero/stylegan2-ada ffb494b625f081bf729aa8e322106faf0311c228
-->

# 1. StyleGAN2 with Adaptive Discriminator Augmentation (StyleGAN2-ADA)

Official TensorFlow implementation of the paper [Training Generative Adversarial Networks with Limited Data](https://arxiv.org/abs/2006.06676).

![Teaser image](./docs/stylegan2-ada-teaser-1024x252.png)

---

- [1. StyleGAN2 with Adaptive Discriminator Augmentation (StyleGAN2-ADA)](#1-stylegan2-with-adaptive-discriminator-augmentation-stylegan2-ada)
- [2. External data repository](#2-external-data-repository)
- [3. Requirements](#3-requirements)
- [4. Getting started](#4-getting-started)
- [5. Projecting images to latent space](#5-projecting-images-to-latent-space)
- [6. Preparing datasets](#6-preparing-datasets)
- [7. Training new networks](#7-training-new-networks)
- [8. Expected training time](#8-expected-training-time)
- [9. Preparing training set sweeps](#9-preparing-training-set-sweeps)
- [10. Reproducing training runs from the paper](#10-reproducing-training-runs-from-the-paper)
...
# 5. Projecting images to latent space
...
# 9. Preparing training set sweeps
...
# 10. Reproducing training runs from the paper
