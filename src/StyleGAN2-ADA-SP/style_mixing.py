...
LastEditTime: 2022-03-31 22:42:39
FilePath: /Awesome-Ultrasound-Standard-Plane-Detection/src/StyleGAN2-ADA/style_mixing.py
...
if __name__ == "__main__":
    ...
    '''
    parser = argparse.ArgumentParser(description='Generate style mixing image matrix using pretrained network pickle.',
