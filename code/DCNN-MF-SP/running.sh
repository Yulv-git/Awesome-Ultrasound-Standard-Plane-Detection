###
 ...
 # @LastEditTime: 2022-04-08 23:48:29
 # @FilePath: /Awesome-Ultrasound-Standard-Plane-Detection/code/DCNN-MF-SP/running.sh
 # @Description:
### 
...
# CUDA_VISIBLE_DEVICES=1 python main.py --model_type DCNN --model_name DenseNet121 --batch_size 48 --imagenet_pretrained True


CUDA_VISIBLE_DEVICES=1 python main.py --model_type EfficientNet --model_name EfficientNetB6 --batch_size 8
# CUDA_VISIBLE_DEVICES=1 python main.py --model_type EfficientNet --model_name EfficientNetB6 --batch_size 8 --imagenet_pretrained True
